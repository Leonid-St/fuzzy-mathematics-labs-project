...
export interface IPointService {
  ...
  //
  calculateAlphaLevelsGraphS: (
    countAlphaLevels: number,
    A: number,
    B: number
  ) => void;
  calculateAlphaLevelsMountain: (
    countAlphaLevels: number,
    A: number,
    B: number,
    C: number
  ) => void;
  calculateAlphaLevelsTriangle: (
    countAlphaLevels: number,
    A: number,
    B: number,
    C: number
  ) => void;
  calculateAlphaLevelsBackS: (
    countAlphaLevels: number,
    A: number,
    B: number,
    C: number
  ) => void;
  calculateAlphaLevelsTrapeze: (
    countAlphaLevels: number,
    A: number,
    B: number,
    C: number,
  ...
  calculateAlphaLevelsGaussian: (
    countAlphaLevels: number,
    A: number,
    B: number
  ) => void;
  calculateAlphaLevelsSigmoid: (
    countAlphaLevels: number,
    A: number,
    B: number
  ) => void;
  calculateAlphaLevelsRoughMountain: (
    countAlphaLevels: number,
    A: number,
    B: number
  ) => void;
  ...
  calculateAlphaLevelsPointsTrapeze: (
    A: number,
    B: number,
    C: number,
    D: number
...
export class PointService implements IPointService {
  ...
  calculateAlphaLevelsMountain(
    ...
    for (let i = 0; i <= 1; i += step) {
      alphaLevelsStructMountin.push(
        this.fuzzyClass.findXByAlphaLevelGraphMountain(i, A, B, C)
      );
    }
  ...
  calculateAlphaLevelsTriangle(
    ...
    for (let i = 0; i <= 1; i += step) {
      alphaLevelsStructTriangle.push(
        this.fuzzyClass.findXByAlphaLevelGraphTriangle(i, A, B, C)
      );
    }
  ...
  calculateAlphaLevelsBackS(
    ...
    for (let i = 0; i <= 1; i += step) {
      alphaLevelsStructGraphBackS.push(
        this.fuzzyClass.findXByAlphaLevelGraphBackS(i, A, B, C)
      );
    }
  ...
  calculateAlphaLevelsTrapeze(
    ...
    for (let i = 0; i <= 1; i += step) {
      alphaLevelsStructGraphTrapeze.push(
        this.fuzzyClass.findXByAlphaLevelGraphTrapeze(i, A, B, C, D)
      );
    }
  ...
  calculateAlphaLevelsGaussian(countAlphaLevels: number, A: number, B: number) {
    ...
    for (let i = 0; i <= 1; i += step) {
      alphaLevelsStructGraphGaussian.push(
        this.fuzzyClass.findXByAlphaLevelGraphGaussian(i, A, B)
      );
    }
  ...
  calculateAlphaLevelsSigmoid(countAlphaLevels: number, A: number, B: number) {
    ...
    for (let i = 0; i <= 1; i += step) {
      alphaLevelsStructGraphSigmoid.push(
        this.fuzzyClass.findXByAlphaLevelGraphSigmoid(i, A, B)
      );
    }
  ...
  calculateAlphaLevelsRoughMountain(
    ...
    for (let i = 0; i <= 1; i += step) {
      alphaLevelsStructGraphRoughMountain.push(
        this.fuzzyClass.findXByAlphaLevelGraphRoughMountain(i, A, B)
      );
    }
    this.alphaLevelsStructGraphRoughMountain =
  ...
  calculateAlphaLevelsPointsRoughMountain(A: number, B: number) {
    ...
    for (
      let i = 0;
      i < this.alphaLevelsStructGraphRoughMountain.length;
      i += 1
    ) {
    ...
    this.alphaLevelsPointsGraphRoughMountain =
      alphaLevelsPointsGraphRoughMountain;
